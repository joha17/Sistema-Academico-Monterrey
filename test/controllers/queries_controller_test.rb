...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { DesCon: @query.DesCon, FecCon: @query.FecCon, NomCon: @query.NomCon, query_state_id: @query.query_state_id, user_id: @query.user_id }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { DesCon: @query.DesCon, FecCon: @query.FecCon, NomCon: @query.NomCon, query_state_id: @query.query_state_id, user_id: @query.user_id }
    assert_redirected_to query_path(assigns(:query))
  end
