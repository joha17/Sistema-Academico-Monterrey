...
class SuggestionsControllerTest < ActionController::TestCase
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post :create, suggestion: { AutSug: @suggestion.AutSug, CantSug: @suggestion.CantSug, LibSug: @suggestion.LibSug, user_id: @suggestion.user_id }
    end
  ...
  test "should update suggestion" do
    patch :update, id: @suggestion, suggestion: { AutSug: @suggestion.AutSug, CantSug: @suggestion.CantSug, LibSug: @suggestion.LibSug, user_id: @suggestion.user_id }
    assert_redirected_to suggestion_path(assigns(:suggestion))
  end
