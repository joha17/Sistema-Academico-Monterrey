class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:CedUs, :NomUs, :ApUnoUs, :ApDosUs, :edadUs, :FK_NivUs, :dt_ingUs, :dt_salUs, :SecUs, :TelUs, :FK_DirUs, :password, :password_confirmation, :role_id, :photo)
    end
end
